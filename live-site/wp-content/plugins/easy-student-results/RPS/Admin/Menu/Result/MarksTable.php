    ...
    function column_default( $item, $column_name ) {
        switch ( $column_name ) {
            case 'name':
                ...
                $link = sprintf('<strong><a href="?page=%s&marks=%d&student_id=%d" class="edit">%s</a></strong>',$_REQUEST['page'],$_REQUEST['marks'], $item->student_id, $name);
                $add_marks = __( 'Add Marks', $this->TD );

                $actions = array (
                    'edit'      => sprintf('<a href="?page=%s&marks=%d&student_id=%d" class="edit">%s</a>',$_REQUEST['page'],$_REQUEST['marks'], $item->student_id, $add_marks),
                );
            ...
            case 'actions':
                ...
                $link = sprintf('<strong><a href="?page=%s&marks=%d&student_id=%d" class="button button-primary">%s</a></strong>',$_REQUEST['page'],$_REQUEST['marks'], $item->student_id, $name);
