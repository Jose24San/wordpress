...
add_action( 'wp_ajax_nopriv_cdm_email_vendor',array($this, 'email_vendor'));	
...
add_action( 'wp_ajax_nopriv_cdm_add_breadcrumb',array($this, 'add_breadcrumb'));	
		...
		function file_permissions(){
			global $spcdm_ajax;
				...
				echo cdm_file_permissions(sanitize_text_field($_REQUEST['pid'] ));
		...
		function folder_permissions(){
			...
			echo cdm_folder_permissions(sanitize_text_field($_REQUEST['pid'] ));
			die();
		...
		function remove_category(){
			...
			echo $spcdm_ajax->save_cat(sanitize_text_field($_POST['uid'] ));
			die();
		}
