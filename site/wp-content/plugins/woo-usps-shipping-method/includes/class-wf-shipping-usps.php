...
class WF_Shipping_USPS extends WC_Shipping_Method {
	...
	public function __construct() {
		$this->id                 = WF_USPS_ID;
		$this->method_title       = __( 'USPS (BASIC)', 'wf-usps-woocommerce-shipping' );
	...
	public function admin_options() {
		...
		<div class="wf-banner updated below-h2">
			...
			<ul>
				...
				<li><strong>WooForce USPS Premium version for WooCommerce streamlines your complete shipping process and saves time.</strong></li>
				...
				<li><strong>- More Features:</strong> Label Printing without Postage, Automatic Shipment Tracking, Box Packing, Price Adjustment and Many More..</li>
			</ul>
			</p>
			<p><a href="https://www.xadapter.com/product/woocommerce-usps-shipping-plugin-with-print-label/" target="_blank" class="button button-primary">Upgrade to Premium Version</a> <a href="http://uspswoodemo.wooforce.com/wp-admin/admin.php?page=wc-settings&tab=shipping&section=wf_shipping_usps" target="_blank" class="button">Live Demo</a></p>
		</div>
		<style>
		.wf-banner img {
			float: right;
    ...
    public function init_form_fields() {
    	...
    	$this->form_fields  = array(
			'enabled'             => array(
				...
				'default'         => 'no',
                'description'     => __( 'Enable', 'wf-usps-woocommerce-shipping' ),
                'desc_tip'        => true
			),
			'title'               => array(
            ...
            'enable_haszip'  => array(
				...
				'description'     => __( 'If choosen option When destination zip is available, no rates will be shown until customer enters a ZIP / Post code is entered on cart page.', 'wf-usps-woocommerce-shipping' ),
                'desc_tip'        => true
			),
            'api'           => array(
				'title'           => __( 'Common API Settings:', 'wf-usps-woocommerce-shipping' ),
				'type'            => 'title',
				'description'     => sprintf( __( 'You can obtain a USPS user ID by %s, or just use ours by leaving the field blank.', 'wf-usps-woocommerce-shipping' ), '<a href="https://www.usps.com/">' . __( 'signing up on the USPS website', 'wf-usps-woocommerce-shipping' ) . '</a>' ),
		    ),
		    'user_id'           => array(
			...
			'enable_standard_services'  => array(
				'title'           => __( 'Standard Services', 'wf-usps-woocommerce-shipping' ),
				'label'           => __( 'Enable Standard Services from the API', 'wf-usps-woocommerce-shipping' ),
				'type'            => 'checkbox',
				'default'         => 'yes',
				'description'     => __( 'Enable non-flat rate services.', 'wf-usps-woocommerce-shipping' ),
                                'desc_tip'        => true
			),
			'offer_rates'   => array(
