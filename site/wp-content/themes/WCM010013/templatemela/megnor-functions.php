...
function tm_set_default_options()
{
	...
	add_option("tmoption_topbar_instagram","#"); // topbar_instagram
...
function templatemela_get_topbar_social() {
	...
	$tmoption_topbar_instagram = get_option('tmoption_topbar_instagram');
	...
	$output .= '<div class="topbar-social">';
		...
		if (!empty($tmoption_topbar_instagram))
		$output .= '<div class="social-instagram content"><a href="'.$tmoption_topbar_instagram.'" target="_Blank"><i class="fa fa-instagram"></i></a></div>';
...
function tm_related_products_args( $args ) {
	...
	add_action('wp_print_styles', 'megashop_dequeue_css_from_plugins', 100);
	function megashop_dequeue_css_from_plugins()  {
